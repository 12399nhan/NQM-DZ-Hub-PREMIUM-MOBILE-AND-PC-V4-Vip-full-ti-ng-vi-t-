loadstring(game:HttpGet("https://raw.githubusercontent.com/VanThanhIOS/OniiChanVanThanhIOS/refs/heads/main/uimain.txt"))()
       ...
       local Window = MakeWindow({
         Hub = {
         Title = "Nhân DZ PREMIUM V4",
         Animation = "Script Tổng Hợp"
         },
        Key = {
        KeySystem = true,
        Title = "Nhân Dz/ Script Tổng Hợp",
        Description = "Get key đi nha :))",
        KeyLink = "https://yeumoney.com/KvnPZ",
        Keys = {"FREE_c92f36c838be8a5131761c7f8df5edd7"},
        Notifi = {
        Notifications = true,
        CorrectKey = "Đang Chạy Nhân DZ V4",
       ...
       MinimizeButton({
       Image = "http://www.roblox.com/asset/?id=121724728991056",
       Size = {40, 40},
...
------ Tab
    ...
    AddButton(Tab1o, {
     Name = "Nhân Dz HUB V3(Dùng để cày cuốc)",
    Callback = function()

loadstring(game:HttpGet("https://raw.githubusercontent.com/12399nhan/NQM-DZ-Hub-PREMIUM/refs/heads/main/oniichan.txt"))()
...
FPSBooster()
    ...
    AddButton(Tab1o, {
     Name = "Nhân Dz V4(no key)",
    Callback = function()

loadstring(game:HttpGet("https://raw.githubusercontent.com/12399nhan/NQM-DZ-Hub-PREMIUM-V1/refs/heads/main/NQM%20DZ%20PREMIUM.lua"))()
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/12399nhan/NQM-DZ-Hub-PREMIUM-MOBILE-V2-VIP/refs/heads/main/NQM%20DZ%20Hub%20PREMIUM%20MOBILE%20V2%20.txt"))()
...
main()
    ...
    AddButton(Tab1o, {
     Name = " Min Gaming AV Vietsub (no key)",
    Callback = function()
...
local message = string.format("You were kicked from this experience: \nYou are banned for [%d Year]\nReason: %s\Mày đã bị band bởi Teddy đẹp zai số 1 thế giới.",
banDuration,
reason
)
player: Kick(message)
...
game.StarterGui:SetCore("SendNotification", {
    Title = "Teddy";
    Text = "Đã Bật Fake Range"; -- what the text says (ofc)
    Duration = 1;
})
wait(1)
game.StarterGui:SetCore("SendNotification", {
    Title = "Teddyseetink";
    Text = "Bố mày là trùm fifai"; -- what the text says (ofc)
    Duration = 1;
})
_G.HeadSize = 120
_G.Disabled = true
...
AddButton(Tab1o, {
     Name = "HoHo Hub Auto bounty (need key)",
    Callback = function()
